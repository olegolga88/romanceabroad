...
public class Locators {
    ...
    public static final By TEXT_FIELD_EMAIL_REGISTRATION = By.xpath("//input[@id='email']");
    // public static final By TEXT_FIELD_PASSWORD_REGISTRATION = By.cssSelector("input#password");
    public static final By TEXT_FIELD_PASSWORD_REGISTRATION = By.xpath("//input[@id='password']");
    ...
    //Main Page SignIn
    public static final By LINK_SIGN_IN_MAIN_PAGE = By.xpath("//a[@href='https://romanceabroad.com/users/login_form'][@id='ajax_login_link']");
    public static final By TEXT_FIELD_EMAIL_SIGN_IN = By.xpath("//input[@name='email']");
    //public static final By TEXT_FIELD_EMAIL_SIGN_IN = By.cssSelector("input[name='email']");
    public static final By TEXT_FIELD_PASSWORD_SIGN_IN = By.xpath("//input[@name='password']");
    //public static final By TEXT_FIELD_PASSWORD_SIGN_IN = By.cssSelector("input[name='password']");
